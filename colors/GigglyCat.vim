...
if has("gui_running") || &t_Co == 256
    ...
    " --- PURPLE TYPE ACCENT (single use) ---
    hi Type          cterm=NONE ctermfg=141 ctermbg=16  gui=NONE guifg=#be95ff guibg=#000000
    ...
    " --- CMDLINE (remove blue, use noir + purple prompt) ---
    hi Cmdline        cterm=NONE ctermfg=245 ctermbg=16  gui=NONE guifg=#8a8a8a guibg=#000000
    hi CmdlinePrompt cterm=NONE ctermfg=141 ctermbg=16  gui=NONE guifg=#be95ff guibg=#000000
    hi FloatBorder   cterm=NONE ctermfg=141 ctermbg=16  gui=NONE guifg=#be95ff guibg=#000000
    ...
    hi Type          cterm=NONE ctermfg=Magenta  ctermbg=Black
